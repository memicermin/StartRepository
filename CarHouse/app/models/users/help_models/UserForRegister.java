package models.users.help_models;

import helpers.DateTimeHelper;
import play.Logger;
import play.data.DynamicForm;
import play.data.validation.Constraints;
import resources.patterns_form.Patterns;
import resources.validation_messages.ValidationMessages;
...
public class UserForRegister {
    ...
    public static UserForRegister createUser(DynamicForm dynamicForm){
        ...
        Logger.info("VRACAM userForRegister");
